...
namespace Repository.Pattern.Ef6
{
    public class Repository<TEntity> : IRepositoryAsync<TEntity> where TEntity : class, IObjectState
    {
        ...
        internal async Task<IEnumerable<TEntity>> SelectAsync(
            ...
            int? pageSize = null)
        {
            return await Select(filter, orderBy, includes, page, pageSize).ToListAsync();//.AsNoTracking()
        }
        ...
        //    // discovered entity with ObjectState.Modified, sync this with provider e.g. EF by neo
        //    if (objectState != null && objectState.ObjectState == ObjectState.Modified)
        //        _context.SyncObjectState((IObjectState)entity);
        ...
        public Boolean RemoveHoldingEntityInContext(TEntity entity)
        {
