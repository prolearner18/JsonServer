...
!function ($) {
    ...
    BootstrapTable.prototype.resetFooter = function () {
        ...
        $.each(bt.options.columns, function (i, column) {
            ...
            if (bt.options.cardView && (!column.cardVisible)) {
                return;
            }
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = that.options.cardView ?
                        ['<div class="card-view">',
                            that.options.showHeader ? sprintf('<span class="title" %s>%s</span>', style,getPropertyFromOther(that.options.columns, 'field', 'title', field)) : '',
                    ...
                    //    if (result.length > 0) {
                    //        htmlstr.push('<td>'+value+'<table class="" style="border:1px #ddd solid; width:100%"> ');
                    ...
                    //            htmlstr.push('</tr>');
                    //        }
                    //        htmlstr.push('</table></td>');
                    //    }
                    //    text = that.options.cardView ?
                    //    ['<div class="card-view">',
                    //        that.options.showHeader ? sprintf('<span class="title" %s>%s</span>', style, getPropertyFromOther(that.options.columns, 'field', 'title', field)) : '',
                    //        sprintf('<span class="value">%s</span>', htmlstr.join('')),
                    //        '</div>'].join('') : htmlstr.join('');
                    //}
