!function ($) {
    ...
    DRPGlobal.template = '<div class="progress">' +
		'<div class="bar bar-success progress-bar progress-bar-success progress-bar-striped " style="width: 0%;"></div>' +
        '<div class="bar bar-warning progress-bar progress-bar-warning progress-bar-striped" style="width: 0%;"></div>' +
        '<div class="bar bar-danger progress-bar progress-bar-danger progress-bar-striped" style="width: 0%;"></div>' +
		'</div>';
