    ...
    var _showStep = function($this, stepIdx) {
        ...
        if ($this.options.transitionEffect == 'slide'){
            ...
            if (stepIdx == prevCurStepIdx) {
                ...
                $($(curStep, $this.target).attr("href"), $this.target).animate({ left: curElementLeft }, "slow", function (e) {
                    $($(curStep, $this.target).attr("href"), $this.target).hide();
                });
            }

            _step($this, selStep).css("left", nextElmLeft1).show().animate({ left: nextElmLeft2 }, "slow", function (e) {
                _setupStep($this,curStep,selStep);
            });
        } else {
